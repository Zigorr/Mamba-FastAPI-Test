...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173","http://localhost:8000", "http://178.128.90.137", "https://front-genta.xyz"],  # Or restrict to your frontend URL like ["https://yourfrontend.com"]
